...
# Puedes definir qué caracteres son inválidos y cómo quieres reemplazarlos.
# Por ejemplo, reemplazarlos con un guion bajo o simplemente eliminarlos.
invalid_chars = ['\\', '/', ':', '*', '?', '"', '<', '>', '|']
for char in invalid_chars:
    output_filename = output_filename.replace(char, '') # O char, '_' para reemplazar con guiones bajos
# --- FIN DE LA SOLUCIÓN ---

# Crea la ruta absoluta para el archivo de salida
output_path = os.path.join(
    'C:\\Users\\PEPE\\Documents\\Proyectos-Data\\TXT\\transcripciones\\',
    output_filename + '.txt'
)
