...
Transfo_Video_Audio = "C:\\Users\\PEPE\\Documents\\Proyectos-Data\\Scripts\\Video_Audio.py"

#Antes de avanzar a la transf a texto hay que dividir el audio
Transfo_Divide_Audio = "C:\\Users\\PEPE\\Documents\\Proyectos-Data\\Scripts\\Divide_Audio.py" 

#transformar desde el TEXTO todo el que encuentre en la carpeta mencionada en la ruta abajo
Transfo_Audio_Texto = "C:\\Users\\PEPE\\Documents\\Proyectos-Data\\Scripts\\Audio_Texto.py"
...
#
union_gramatical = "C:\\Users\\PEPE\\Documents\\Proyectos-Data\\Scripts\\Union_Gramatical.py"

#grafica de barras de toda una conv
#no me acuerdo para que era este
Graficar_Dialogo = "C:\\Users\\PEPE\\Documents\\Proyectos-Data\\Scripts\\Graficar_Dialogo.py"


#Seguimiento de palabras, Bi_Grama, palabra1 y palabra2
seguimiento_palabras = "C:\\Users\\PEPE\\Documents\\Proyectos-Data\\Scripts\\Seguim_Palabras.py"
...
ventana = tk.Tk()
ventana.title("50 palabras frecuentes")
